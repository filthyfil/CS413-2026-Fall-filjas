...
** Source: Introduction to Programming in ATS (INT2PROGINATS)
...
**
** Build: patscc -DATS_MEMALLOC_LIBC -o eight_queens eight_queens.dats
*)
...
val nsol = search (bd0, 0(*i*), 0(*j*), 0(*nsol*))
//
in
